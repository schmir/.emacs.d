...
;;; Initialize site-lisp directory
(defun update-all-autoloads ()
  (interactive)
  (let ((loaddefs-path (expand-file-name "site-loaddefs.el" site-lisp-directory))
        (make-backup-files nil))
    (loaddefs-generate (list site-lisp-directory) loaddefs-path nil ";;; huhu")))
...
(update-all-autoloads)
(load (expand-file-name "site-loaddefs.el" site-lisp-directory) nil t)
