...
(defvar prelude-packages '(pkg-info clojure-mode slamhound
  ...
  escreen smart-tab gist w3m php-mode markdown-mode textile-mode cider ac-cider
  deft rainbow-delimiters shell-pop projectile ack-and-a-half flycheck
  nginx-mode batch-mode ace-jump-mode bbdb)
